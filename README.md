...
- **Phase 3 (in progress):** `src/features/` and `src/scoring/` built and dry-run verified (`docs/phase3_dry_run.md`); missing-data policy resolved (`docs/phase3_missing_data_decision.md`); validation procedures designed but not executed (`docs/phase3_validation_design.md`). No rankings, percentiles, or priority tiers exist yet — computing and publishing those is a separate, not-yet-authorized step.
